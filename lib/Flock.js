		...
		execute: function () {
			...
			Flock = function () {
				...
				_createClass(Flock, [{
					...
					key: 'rule1',
					value: function rule1(center, boid) {
					...
					key: 'rule3',
					value: function rule3(boid) {
						var neighbors = this.getNeighbors(boid, 80);
