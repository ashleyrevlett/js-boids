...
System.register(['Boid.js', '../node_modules/sat/SAT.js'], function (_export, _context) {
	"use strict";

	var Boid, SAT, _createClass, Flock;
		...
		execute: function () {
			...
			Flock = function () {
				...
				_createClass(Flock, [{
					...
					key: 'calculateCenter',
					value: function calculateCenter(neighbors) {
						var averageX = 0;
						var averageY = 0;
						for (var i = 0; i < neighbors.length; i++) {
							averageX += neighbors[i].circle.pos.x;
							averageY += neighbors[i].circle.pos.y;
						}
